...
alias ls="eza --color=always --git --no-filesize --icons=always --no-time --no-user --no-permissions --tree --level=2"
alias ll="eza --color=always --git --long --tree --icons=always --level=2 --time-style='${ls_time_style_long}'"
